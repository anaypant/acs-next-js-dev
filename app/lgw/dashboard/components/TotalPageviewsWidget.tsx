...
const TotalPageviewsWidget = () => {
  return (
    <div className="bg-white rounded-xl shadow-xl border p-4 flex flex-col h-full">
      <h3 className="text-xs font-semibold text-gray-700 mb-2 tracking-wide">TOTAL PAGEVIEWS</h3>
      <div className="text-3xl font-bold text-[#0e6537] mb-2">252,292</div>
...
export default TotalPageviewsWidget; 