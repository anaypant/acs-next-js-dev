      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">View completed conversations and past interactions</p>
          </div>
        </div>
      </div>
...
export default function HistoryPage() {
  return (
    <PageLayout title="History" showNavbar={false}>
      <ErrorBoundary fallback={
        <div className="flex items-center justify-center h-full">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-red-600 mb-4">History Error</h2>
            <p className="text-gray-600 mb-4">Something went wrong with the history page.</p>
            <button 
